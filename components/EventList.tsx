          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <input
                ...
                className="w-24 py-2 px-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                placeholder="Min"
                min="0"
              />
              <span>-</span>
      ...
      {filteredEvents.length > 0 ? (
        ...
        <div className="bg-white p-8 rounded-lg shadow text-center">
          ...
          {isFilterActive && (
            <button
              onClick={clearFilters}
              className="mt-3 inline-flex items-center px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700"
            >
