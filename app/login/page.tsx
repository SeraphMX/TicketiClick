    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-md mx-auto px-4 sm:px-6">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          {/* Cabecera */}
          <div className="px-6 pt-8 pb-6 bg-gradient-to-r from-purple-700 to-indigo-800 text-white">
            <h1 className="text-2xl font-bold mb-1">Iniciar Sesión</h1>
            <p className="text-purple-100">Accede a tu cuenta para comprar boletos y más</p>
          </div>
          ...
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-100">
            ...
            <p className="text-xs text-gray-500 mt-2">
              * Haz clic en cualquier usuario demo para iniciar sesión automáticamente
            </p>
          </div>
        </div>
      </div>
