      ...
      {['Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun'].map((month, index) => {
        ...
        return (
          <div key={index} className="flex flex-col items-center">
            <div 
              className="w-12 bg-gradient-to-t from-purple-600 to-indigo-500 rounded-t-md transition-all duration-500"
              style={{ height: `${height}%` }}
            ></div>
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      <div className="border-b border-gray-200 pb-5 mb-6">
        ...
        <p className="text-gray-600 mt-1">
          Vista general de estadísticas y actividad de la plataforma
        </p>
      </div>
            ...
            <div className="flex space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500">
                  Laura Martínez se unió a la plataforma
                </p>
              </div>
          ...
          <li className="py-3">
            <div className="flex space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500">
                  2 boletos vendidos para "Concierto de Rock en Vivo"
                </p>
              </div>
              <div className="flex-shrink-0 whitespace-nowrap text-sm text-gray-500">
                hace 4 horas
          ...
          <li className="py-3">
            <div className="flex space-x-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500">
                  "Festival de Gastronomía" por María González
                </p>
              </div>
              <div className="flex-shrink-0 whitespace-nowrap text-sm text-gray-500">
                hace 1 día
